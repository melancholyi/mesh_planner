 ...
 * @FilePath: /mesh_planner/src/mesh_planner/mesh_bgk/include/mesh_bgk/bgk.hpp
 * @Description: 
 * 
...
namespace bgk_interface{
    ...
    class BGKInterface{
        using InputType  = Eigen::Matrix<T, -1, INPUT_DIM,  Eigen::RowMajor>; // n *  input_dim
        using OutputType = Eigen::Matrix<T, -1, OUTPUT_DIM, Eigen::RowMajor>; // n * output_dim
        using KernelType = Eigen::Matrix<T, -1, -1, Eigen::RowMajor>; // 
